...
namespace DocaLabs.Http.Client.Binding.PropertyConverting
{
    ...
    public class SimpleDictionaryPropertyConverter : IPropertyConverter 
    {
        ...
        SimpleDictionaryPropertyConverter(PropertyInfo property)
        {
            ...
            _valueConverter = new SimpleDictionaryValueConverter(name, format, culture);
        }
        ...
        {
            return !property.IsIndexer() && property.GetMethod != null && SimpleDictionaryValueConverter.CanConvert(property.PropertyType);
        }
    }
}