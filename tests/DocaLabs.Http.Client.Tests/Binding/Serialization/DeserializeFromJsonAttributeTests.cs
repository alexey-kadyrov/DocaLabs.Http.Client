...
namespace DocaLabs.Http.Client.Tests.Binding.Serialization
{
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_with_null_charset_and_the_response_has_content_type_with_charset : response_deserialization_test_context
    {
        const string data = "{Value1:2012, Value2:\"Hello World!\"}";
        static DeserializeFromJsonAttribute deserializer;
        static TestTarget target;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_with_null_charset_and_the_response_does_not_have_charset_in_content_type : response_deserialization_test_context
    {
        const string data = "{Value1:2012, Value2:\"Hello World!\"}";
        static DeserializeFromJsonAttribute deserializer;
        static TestTarget target;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_with_empty_charset_and_the_response_does_not_have_charset_in_content_type : response_deserialization_test_context
    {
        const string data = "{Value1:2012, Value2:\"Hello World!\"}";
        static DeserializeFromJsonAttribute deserializer;
        static TestTarget target;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_with_specified_charset : response_deserialization_test_context
    {
        const string data = "{Value1:2012, Value2:\"Hello World!\"}";
        static DeserializeFromJsonAttribute deserializer;
        static TestTarget target;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_and_there_is_charset_on_content_type : response_deserialization_test_context
    {
        const string data = "{Value1:2012, Value2:\"Hello World!\"}";
        static DeserializeFromJsonAttribute deserializer;
        static TestTarget target;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_with_empty_response_stream : response_deserialization_test_context
    {
        const string data = "";
        static DeserializeFromJsonAttribute deserializer;
        static TestTarget target;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_with_null_result_type : response_deserialization_test_context
    {
        const string data = "{Value1:2012, Value2:\"Hello World!\"}";
        static Exception exception;
        static DeserializeFromJsonAttribute deserializer;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "deserialization")]
    class when_json_deserializer_is_used_with_null_response : response_deserialization_test_context
    {
        static Exception exception;
        static DeserializeFromJsonAttribute deserializer;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_with_null_response : response_deserialization_test_context
    {
        static Exception exception;
        static DeserializeFromJsonAttribute deserializer;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_on_bad_json_value : response_deserialization_test_context
    {
        const string data = "} : Non JSON string : {";
        static DeserializeFromJsonAttribute deserializer;
        static Exception exception;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "async deserialization")]
    class when_json_deserializer_is_used_asynchronously_with_bad_charset : response_deserialization_test_context
    {
        const string data = "{Value1:2012, Value2:\"Hello World!\"}";
        static DeserializeFromJsonAttribute deserializer;
        static Exception exception;
    ...
    [Subject(typeof(DeserializeFromJsonAttribute), "checking that can deserialize")]
    class when_json_deserializer_is_checking_with_null_response : response_deserialization_test_context
    {
        static Exception exception;
        static DeserializeFromJsonAttribute deserializer;
