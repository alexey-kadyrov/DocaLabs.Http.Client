...
namespace DocaLabs.Http.Client.Tests.Binding.Serialization
{
    ...
    [Subject(typeof(SerializeAsFormAttribute))]
    class when_serialize_as_form_attribute_is_used_asynchronously : request_serialization_test_context
    {
        static TestTarget original_object;
        static SerializeAsFormAttribute attribute;
    ...
    [Subject(typeof(SerializeAsFormAttribute))]
    class when_serialize_as_form_attribute_is_used_asynchronously_with_gzip_content_encoding : request_serialization_test_context
    {
        static TestTarget original_object;
        static SerializeAsFormAttribute attribute;
    ...
    [Subject(typeof(SerializeAsFormAttribute))]
    class when_serialize_as_form_attribute_is_used_asynchronously_with_utf_32_charset : request_serialization_test_context
    {
        static TestTarget original_object;
        static SerializeAsFormAttribute attribute;
    ...
    [Subject(typeof(SerializeAsFormAttribute))]
    class when_serialize_as_form_attribute_is_used_asynchronously_with_null_object : request_serialization_test_context
    {
        static SerializeAsFormAttribute attribute;
    ...
    [Subject(typeof(SerializeAsFormAttribute))]
    public class when_serialize_as_form_attribute_is_used_asynchronously_with_null_request : request_serialization_test_context
    {
        static Exception exception;
        static TestTarget original_object;
        static SerializeAsFormAttribute attribute;
